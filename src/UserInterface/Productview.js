...
export default function Productview(props) {
    ...
    const [image,setImage]=React.useState(product.picture)
...
setRefresh(!refresh)
    ...
    return(
     <>
        ...
        <ArrowBackIos onClick={()=>imageSlider.current.slickPrev()} style={{ cursor: "pointer",fontSize:32,color:'#95a5a6'}} />
        </div>
     ...
     <CartButton onChange={(value)=>handleQtyChange(value,product)} />
